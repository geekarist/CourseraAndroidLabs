...
public class ToDoListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View itemLayout = newItemViewOrRecycledFrom(convertView);

        final TextView titleView = (TextView) itemLayout.findViewById(R.id.titleView);
        titleView.setText(toDoItem.getTitle());

        final CheckBox statusView = (CheckBox) itemLayout.findViewById(R.id.statusCheckBox);
        statusView.setChecked(toDoItem.getStatus() == DONE);
        ...
        statusView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                toDoItem.setStatus(toDoItem.getStatus() == DONE ? NOTDONE : DONE);
            }
        });
    ...
    private View newItemViewOrRecycledFrom(View convertView) {
        View itemLayout;
